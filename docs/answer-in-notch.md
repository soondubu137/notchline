...
| A `RequestAnswering` provider per product | The write path's other half. The channel is open and the products were measured acting on what comes down it (§14.2); what is still owed is the held descriptor, the reply registry and the two providers |
