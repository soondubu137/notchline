...
| --- | --- | --- |
| Provider protocol | [`AgentMonitoring`](../../../Notchline/Notchline/Products/Codex/LiveCodexMonitorService.swift): product identity, change stream, snapshot and next deadline | Keep the asynchronous observation shape. It already supports independent Providers. |
...
| Navigation | [`AgentNavigationRouter`, `NavigationOutcome`](../../../Notchline/Notchline/AgentNavigation.swift) | Reuse this separation. Outcomes already distinguish opening a Thread, raising an application and focusing a terminal. |
...
| Product evidence | [`LiveCodexMonitorService`](../../../Notchline/Notchline/Products/Codex/LiveCodexMonitorService.swift), [`ClaudeCodeMonitorService`](../../../Notchline/Notchline/Products/ClaudeCode/ClaudeCodeMonitorService.swift) and their repositories | Keep native discovery, Project interpretation, read-state evidence, navigation and protocol parsing at these boundaries. Do not erase their differences. |
