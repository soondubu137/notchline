...
The user authorised documenting all five work packages and implementing work package 1, then explicitly requested **work package 5 next**. Work packages 2–4 remain planned until separately undertaken. Do not quietly broaden package 1 into new request operations, concurrent-request presentation, recovery or a change in support level.
