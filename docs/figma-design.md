...
**The five states** — `Running · Approval · Input · Completed · Connected`, each a chip carrying **two stacked marks, Codex above Claude Code**, and the state's name. No sentences: a state called `Running` does not need one saying a Turn is running.
