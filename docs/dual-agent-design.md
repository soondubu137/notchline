...
| Notch-less, resting | `12 + mark + 6 + mark + 12 + widest status name + 12 = 154` | as left, one mark and one gap fewer: `126` |
| Notch-less, reading `1:23` | `+ 32 + 36 = 222` | as left: `194` |
