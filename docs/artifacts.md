...
| Trae’s managed extension storage: `notchline.trae-companion-1.1.0` | The VSIX installed by Trae’s extension CLI in its configured Extensions directory; JavaScript and manifest only | Trae’s CLI uninstalls this exact extension |
