...
| `07-readme` | 1200 px horizontal lockup for the README header, and the architecture diagram (`notchline-architecture*.svg`, light and dark, regenerated by `notchline-architecture.py`) |
